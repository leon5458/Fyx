...
public class WaterHorizontalLoader extends View {
    /**
     * 宽度
     */
    private int mWidth;
     ...
     * @param context
     */
    public WaterHorizontalLoader(Context context) {
        super(context);
        init();
    }
     ...
     * @param attrs
     */
    public WaterHorizontalLoader(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
     ...
     * @param defStyleAttr
     */
    public WaterHorizontalLoader(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void startAnim() {
         /* x方向 */
        ValueAnimator xValueAnimator = ValueAnimator.ofFloat( 0, mWidth - mDynamicCircle.radius);
